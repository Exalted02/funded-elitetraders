...
Route::middleware(['auth', 'client'])->name('client.')->group(function () {
	...
	//Verification
	Route::get('/verification', [VerificationController::class, 'index'])->name('verification'); //remove 4f.5i>&65n from route
	Route::post('/verification', [VerificationController::class, 'save'])->name('client.verification');  //remove 4f.5i>&65n from route
